...
import { Home, Edit, Trash2, Plus, Eye } from 'lucide-react';
import api from '../services/api';
import UnidadeModal from '../components/UnidadeModal';
import UnidadeDetalhes from '../components/UnidadeDetalhes';
...
const Unidades: React.FC = () => {
  ...
  const [unidadeSelecionada, setUnidadeSelecionada] = useState<UnidadeDetalhada | null>(null);
  ...
  const carregarDetalhesUnidade = async (id: number) => {
    try {
      const response = await api.get<UnidadeDetalhada>(`/unidades/${id}/detalhes`);
            ...
            <div className="flex justify-between">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  {unidade.bloco && (
                    <p className="text-sm text-gray-500">Bloco {unidade.bloco}</p>
                  )}
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => carregarDetalhesUnidade(unidade.id)}
